  ...
  return (
    ...
    >
      <div
        className={
          theme === "dark"
            ? "h-[150px] relative container sm:w-[1024px] sm:mx-auto  bg-blBackground text-3xl flex flex-col items-center justify-center"
            : "h-[150px] relative container sm:w-[1024px] sm:mx-auto bg-lgBackground text-3xl flex flex-col items-center justify-center"
        }
      >
        {openMenu && (
          <div className=" absolute w-screen text-center top-[-25px] h-[300px]">
            <NavMenuDropDown />
          </div>
        )}
